...
For the rest of the theory section, unless specific restrictions are given, assume that $a, b, c$ are positive reals with $a > 1$.
...
$a,b,c,d,$ $\log_{a}b\log_{c}d=\log_{a}d\log_{c}b.$
\end{exer}
